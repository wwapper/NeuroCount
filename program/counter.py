...
ret, threshold_image = cv2.threshold(gray_image, 115, 255, 0)
...
cv2.imwrite('contours_old.jpg', image1) # выводим итоговое изображение в окно
...
for cnt in contours:
    ...
    if area - perimeter > 100:
        new_contours.append(cnt)
# отображаем контуры поверх изображения
cv2.drawContours(image, new_contours, -1, (0,0,0), 3, cv2.LINE_AA)
cv2.imwrite('contours_new.jpg', image) # выводим итоговое изображение в окно
